...
<link href="{{ asset('css/registro.css') }}" rel="stylesheet">
            ...
            <div class="title">
				<h2>Edición de Hardware </h2>
			</div>
            
		<form action="{{ route('hardwares.update',$hardware->hardware_id) }}" 
            ...
            <input type="hidden" value="{{ $hardware->hardware_id }}" name="hardware_id">
			<div>
                ...
                <div class="formulario_grupo-input">
					<select id="category_id" 
						...
						name="category_id" value="{{ $hardware->category_id }}" 
						class="formulario__input">
						@foreach ($categorys as $category)
							@if( $category->category_id == $hardware->category_id  )
			...
			<div>
				...
				<div>
					...
					data-bs-custom-class="color-tooltip"
					required
					maxlength="30" value="{{ $hardware->inventorynumber }}" >
           ...
           <!-- Grupo: Características -->
			<div>
				...
				<div>
					...
					maxlength="100"  value="{{ $hardware->features }}">
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
			...
			<div>
				...
				<div>
					...
					data-bs-custom-class="color-tooltip"
					placeholder="" 
					maxlength="20" value="{{ $hardware->serial }}">
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
			...
			<div>
				...
				<div>
					...
					data-bs-custom-class="color-tooltip"
					maxlength="20" value="{{ $hardware->model }}">
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
			...
			<div>
				...
				<div>
					...
					data-bs-custom-class="color-tooltip"
					name="comments" value="{{ $hardware->comments }}" id="comments" 
             ...
             <div>
                ...
                <select id="brand_id" name="brand_id" value="{{ $hardware->brand_id }}" class="formulario__input">
					@foreach ($brands as $brand)
						@if($brand->brand_id==$hardware->brand_id )
			...
			<div>
                ...
                <select id="area_id" name="area_id" 
					...
					data-bs-custom-class="color-tooltip"
					value="{{ $hardware->area_id }}" class="formulario__input">
					@foreach ($areas as $area)
						@if($area->area_id==$hardware->area_id )
			 ...
			 <div>
                ...
                <select id="email" name="email" 
					...
					data-bs-custom-class="color-tooltip"				
					value="{{ $hardware->email }}" class="formulario__input">
					@foreach ($users as $user)
						@if($user->email==$hardware->email)	
           ...
           <!-- Grupo: Combo Estatus-->
            <div>
                ...
                <div class="formulario_grupo-input"></div>
                <select id="status_id" name="status_id" value="{{ $hardware->status_id }}" class="formulario__input">
					@foreach ($statuses as $status)
						@if($status->status_id==$hardware->status_id)	
			...
			<div id="divIdentifier">
				...
				<div>
					...
					data-bs-custom-class="color-tooltip"					
					name="identifier" value="{{ $hardware->identifier }}" 
			...
			<div id="divRam">
				...
				<div>
					...
					data-bs-custom-class="color-tooltip"	
					name="ram" value="{{ $hardware->ram }}" id="ram" placeholder="16 GB"  
					maxlength="50"  >
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
           ...
           <!-- Grupo: Useros -->
			<div id="divUserOs">
				...
				<div>
					...
					data-bs-custom-class="color-tooltip"					
					name="useros" value="{{ $hardware->useros }}" 
			...
			<div id="divHarddisk">
				...
				<div>
					...
					data-bs-custom-class="color-tooltip"					
					name="harddisk" value="{{ $hardware->harddisk }}" 
			...
			<div id="divProcessor">
				...
				<div>
					...
					data-bs-custom-class="color-tooltip"					
					name="processor" value="{{ $hardware->processor }}" id="processor"
